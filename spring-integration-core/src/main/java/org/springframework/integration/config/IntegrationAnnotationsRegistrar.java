...
/**
 * {@link ImportBeanDefinitionRegistrar} implementation that registers additional {@link BeanDefinition}s
 * for post-processing method-level annotations.
 *
 * @author Jiandong Ma
 *
 * @since 7.2
 ...
 */
public class IntegrationAnnotationsRegistrar implements ImportBeanDefinitionRegistrar {
	...
	/**
	 * Register {@link MessagingAnnotationPostProcessor} and{@link MessagingAnnotationBeanPostProcessor},
	 * if necessary.
