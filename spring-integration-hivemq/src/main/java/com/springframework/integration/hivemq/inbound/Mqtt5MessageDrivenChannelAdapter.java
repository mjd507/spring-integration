...
import com.springframework.integration.hivemq.ClientCoordinators;
...
public class Mqtt5MessageDrivenChannelAdapter extends
	...
	private HeaderMapper<Mqtt5Publish> headerMapper;
	...
	protected void onInit() {
		...
		if (this.headerMapper == null) {
			this.headerMapper = new Mqtt5HeaderMapper();
		}
	}
	...
	protected void doStart() {
		super.doStart();
		ClientCoordinators.mqtt5AsyncClient().connect(mqttClient, this.mqttConnect)
	...
	protected void doStop() {
		super.doStop();
		ClientCoordinators.mqtt5AsyncClient().disconnect(mqttClient, this.mqttDisConnect)
