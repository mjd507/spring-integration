...
/**
 * A {@link ClientCoordinator} implementation for {@link Mqtt3AsyncClient}.
 *
 * @author Jiandong Ma
 *
 * @since 7.2
 */
class Mqtt3AsyncClientCoordinator implements ClientCoordinator<Mqtt3AsyncClient, Mqtt3ConnectView, Object> {
